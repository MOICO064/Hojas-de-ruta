...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            ...
            <h6 class="d-none"> <span id="gestion">{{ $hoja->gestion}}</span></h6>
        </div>
        ...
        <div class="col-lg-8 col-md-10 col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h4 class="mb-0">Registrar Derivación</h4>
                </div>
                ...
                <div class="card-body py-4">
                    <form id="derivacionForm">
                        ...
                        <div class="mb-4">
                                ...
                                <div class="destinatario-item border rounded p-3 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="destinatarios[0][unidad_destino_id]"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Funcionario Responsable <small
                                                    class="text-danger">*</small></label>
                                            <select name="destinatarios[0][funcionario_id]" class="form-select funcionario">
                                    ...
                                    <div class="text-end">
                                        <button type="button"
                                            class="btn btn-sm btn-outline-danger btn-remove-destinatario d-none">
                            ...
                            {{-- BOTÓN AGREGAR --}}
                            <button type="button" id="addDestinatario"
                        ...
                        {{-- DESCRIPCIÓN --}}
                        <div class="mb-3">
                            <label class="form-label">Descripción / Instrucciones <small
                                    class="text-danger">*</small></label>
                        ...
                        {{-- FOJAS --}}
                        <div class="mb-3">
                            <label class="form-label">Fojas <small>(opcional)</small></label>
                            <input type="number" name="fojas" class="form-control" min="1">
                            <div class="invalid-feedback"></div>
                        </div>

                        {{-- FILEPOND PDF --}}
                        <div class="mb-4">
                            <label class="form-label">Documento PDF <small>(opcional)</small> </label>
                            <input type="file" id="pdfFile" class="filepond" name="pdf" accept="application/pdf">
                            <small class="text-muted">
                                Solo PDF · Máx. 1 archivo
                            </small>
                        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/derivaciones/form.js') }}"></script>
    <script>
        window.unidades = @json($unidades);
    </script>
    <script src="{{ asset('js/derivaciones/destinos.js') }}"></script>
@endsection