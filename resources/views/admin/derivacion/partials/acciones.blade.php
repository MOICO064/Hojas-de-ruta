<div class="d-flex gap-2">
    ...
    {{-- Ver PDF --}}
    @if($row->pdf)
    <a href="{{  $row->pdf }}" target="_blank" class="btn btn-sm btn-info" title="Ver PDF">
    ...
    <a href="{{ route('admin.reportes.derivaciones', [
        'derivaciones[]' => $row->id
    ]) }}" target="_blank" class="btn btn-sm btn-secondary" title="Imprimir Derivación">
    ...
    {{-- Anular Derivación --}}
    <button type="button" class="btn btn-sm btn-danger btn-anular" data-url="" title="Anular Derivación">
