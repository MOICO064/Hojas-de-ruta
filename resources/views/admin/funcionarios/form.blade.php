                ...
                <form id="funcionarioForm">
                    ...
                    <div class="mb-3">
                        <label class="form-label d-flex align-items-center gap-2">
                            <i data-feather="layers"></i> Unidad <span class="text-danger">*</span>
                        </label>
                        <select name="unidad_id" id="unidad_id" class="form-select">
                            <option value="">-- Seleccione una Unidad --</option>
                            @foreach($unidades as $u)
                            <option value="{{ $u->id }}"
                                {{ isset($funcionario) && $funcionario->unidad_id == $u->id ? 'selected' : '' }}>
                                {{ $u->nombre }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        <label class="form-label d-flex align-items-center gap-2">
                            <i data-feather="credit-card"></i> Cédula de Identidad<span class="text-danger">*</span>
                        </label>
                    ...
                    <div class="mb-3">
                        <label class="form-label d-flex align-items-center gap-2">
                            <i data-feather="user"></i> Nombre Completo<span class="text-danger">*</span>
                        </label>
