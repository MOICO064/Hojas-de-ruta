                    ...
                    <form id="unidadForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="estado" id="estado" class="form-select">
                                <option value="ACTIVO" {{ (isset($unidad) && $unidad->estado == 'ACTIVO') ? 'selected' : '' }}>ACTIVO</option>
                                <option value="INACTIVO" {{ (isset($unidad) && $unidad->estado == 'INACTIVO') ? 'selected' : '' }}>INACTIVO</option>
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
