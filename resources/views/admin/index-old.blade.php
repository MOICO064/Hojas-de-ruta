                    ...
                    <div class="col">
                        <div class="card h-100 card-lift">
                            <div class="card-body">
                                ...
                                <span class="text-danger "><i class="me-1 icon-xs"
                                        data-feather="arrow-down"></i>-26.50%</span>
                    ...
                    <div class="col">
                        <div class="card h-100 card-lift">
                            <div class="card-body">
                                ...
                                <span class=" text-success "><i class="me-1 icon-xs"
                                        data-feather="arrow-up"></i>-2.50%</span>
                    ...
                    <div class="col">
                        <div class="card h-100 card-lift">
                            <div class="card-body">
                                ...
                                <span class="text-danger "><i class="me-1 icon-xs"
                                        data-feather="arrow-down"></i>-1.83%</span>
                    ...
                    <div class="col">
                        <div class="card h-100 card-lift">
                            <div class="card-body">
                                ...
                                <span class="text-success "><i class="me-1 icon-xs"
                                        data-feather="arrow-up"></i>21.50%</span>
                                <small>vs 2.19 (prev.)</small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 col-md-12 col-12 mb-5">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div>
                            <small><span class="mdi mdi-lightbulb-outline me-1"></span>How perfformed over
                                the last 30
                                days?</small>
                        </div>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>8,864</span><span class="ms-4 text-dark">34.54%</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Sweden</td>
                                            <td><span>6,749</span><span class="ms-4 text-dark">5.29%</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Russia</td>
                                            <td><span>5,523</span><span class="ms-4 text-dark">4.54%</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Mexico</td>
                                            <td><span>3,214 </span><span class="ms-4 text-dark">3.12%</span>
                                            </td>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="#!" class="btn btn-outline-white btn-sm">Export <i data-feather="arrow-down"
                                class="icon-xxs"></i></a>
                            ...
                            <table class="table mb-0 text-nowrap table-centered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div>
                                                <div>5,056 <span class="text-success"><i data-feather="arrow-up"
                                                            class="icon-xs"></i><span class="ms-1">1%</span></span></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>/landings/courses.html <a href="#!" class="text-inherit"><i
                                                    data-feather="external-link" class="icon-xs"></i></a>
                                        </td>
                                        <td class="text-end">
                                            <div>
                                                <div>2,385 <span class="text-danger"><i data-feather="arrow-down"
                                                            class="icon-xs"></i><span class="ms-1">1%</span></span></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>/landings/lead.html <a href="#!" class="text-inherit"><i
                                                    data-feather="external-link" class="icon-xs"></i></a>
                                        </td>
                                        <td class="text-end">
                                            <div>
                                                <div>634 <span class="text-danger"><i data-feather="arrow-down"
                                                            class="icon-xs"></i><span class="ms-1">1%</span></span></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>/dashboard.html <a href="#!" class="text-inherit"><i
                                                    data-feather="external-link" class="icon-xs"></i></a>
                                        </td>
                                        <td class="text-end">
                                            <div>
                                                <div>650 <span class="text-success"><i data-feather="arrow-up"
                                                            class="icon-xs"></i><span class="ms-1">9%</span></span></div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div>
                                                <div>243 <span class="text-danger"><i data-feather="arrow-down"
                                                            class="icon-xs"></i><span class="ms-1">3%</span></span></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>/blog.html <a href="#!" class="text-inherit"><i data-feather="external-link"
                                                    class="icon-xs"></i></a>
                                        </td>
                                        <td class="text-end">
                                            <div>
                                                <div>209 <span class="text-danger"><i data-feather="arrow-down"
                                                            class="icon-xs"></i><span class="ms-1">2%</span></span></div>
                                ...
                                <tbody>
                                        ...
                                        <td class="ps-0">
                                            <div class="progress" style="height: 4px;">
                                                <div class="progress-bar bg-info" role="progressbar"
                                                    aria-label="Basic example" style="width: 75%" aria-valuenow="75"
                                        ...
                                        <td class="ps-0">
                                            <div class="progress" style="height: 4px;">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    aria-label="Basic example" style="width: 54%" aria-valuenow="54"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="ps-0">
                                            <div class="progress" style="height: 4px;">
                                                <div class="progress-bar bg-warning" role="progressbar"
                                                    aria-label="Basic example" style="width: 34%" aria-valuenow="34"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <div class="progress" style="height: 4px;">
                                                <div class="progress-bar bg-info" role="progressbar"
                                                    aria-label="Basic example" style="width: 23%" aria-valuenow="23"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="ps-0">
                                            <div class="progress" style="height: 4px;">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                                    aria-label="Basic example" style="width: 14%" aria-valuenow="14"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-0">
                        ...
                        <table class="table mb-0">
                            <tbody>
                                <tr>
                                    <td class="border-top-0 "> <img src="../assets/images/svg/browser-svg/chrome.svg"
                                            alt="Image" class="me-2"><span>Google
                                            Chrome</span></td>
                                    <td class="text-end border-top-0  ">21.54%</td>

                                </tr>
                                <tr>
                                    <td> <img src="../assets/images/svg/browser-svg/firefox.svg" alt="Image"
                                            class="me-2"><span>Mozilla
                                            Firefox</span></td>
                                    <td class="text-end  ">14.43%</td>

                                </tr>
                                <tr>
                                    <td> <img src="../assets/images/svg/browser-svg/brave.svg" alt="Image"
                                            class="me-2"><span>Brave</span></td>
                                    <td class="text-end  ">14.43%</td>

                                </tr>
                                <tr>
                                    <td> <img src="../assets/images/svg/browser-svg/safari.svg" alt="Image"
                                            class="me-2"><span>Apple
                                            Safari</span></td>
                                ...
                                <tr>
                                    <td> <img src="../assets/images/svg/browser-svg/ie.svg" alt="Image"
                                            class="me-2"><span>Internet Export</span>
                                    </td>
