...
<div class="d-flex justify-content-between align-items-center mb-5">
    <div>
        ...
        @if(isset($buzon))
        <span class="badge bg-info text-dark fs-6 mb-0" id="tipoBuzon"> {{ $buzon }}</span>
        @endif
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-card">
                    <table id="buzon-table" class="table text-nowrap mb-0 table-centered table-hover w-100">
...
@section('scripts')
<script src="{{ asset('js/buzon/index.js') }}"></script>
<script src="{{ asset('js/buzon/recepcionar.js') }}"></script>
<script src="{{ asset('js/buzon/concluir.js') }}"></script>
