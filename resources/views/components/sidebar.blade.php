    ...
    <div class="h-100" data-simplebar>
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <div class="d-none">
                ...
                <li class="nav-item">
                    ...
                    <div id="navDashboard" class="collapse  show " data-bs-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link  active " href="../pages/dashboard-analytics.html">Analytics</a>
                            </li>
                            <li class="nav-item">
                ...
                <!-- Nav item -->
                <li class="nav-item">
                    <a class="nav-link has-arrow " href="../pages/Dashboard-app.html">
                ...
                <li class="nav-item">
                    ...
                    <div id="navecommerce" class="collapse " data-bs-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link has-arrow " href="../pages/ecommerce-products-details.html">Product
                                    Detail</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  collapsed " href="#!" data-bs-toggle="collapse" data-bs-target="#navlayoutPage"
                        aria-expanded="false" aria-controls="navlayoutPage">
                        <i class="nav-icon me-2 icon-xxs" data-feather="file"></i>
                        Pages
                    </a>
                    ...
                    <div id="navDocs" class="collapse " data-bs-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item"><a href="../docs/environment-setup.html" class="nav-link ">Environment
                                    setup</a></li>
                            <li class="nav-item"><a href="../docs/working-with-gulp.html" class="nav-link ">Working
                                    with Gulp</a></li>
